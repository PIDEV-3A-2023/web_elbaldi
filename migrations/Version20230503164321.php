 ...
 */
final class Version20230503164321 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE command_produit ADD CONSTRAINT command_produit_ibfk_2 FOREIGN KEY (id_cmd) REFERENCES commande (id_cmd) ON UPDATE SET NULL ON DELETE SET NULL');
