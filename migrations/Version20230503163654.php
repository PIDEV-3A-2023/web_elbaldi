 ...
 */
final class Version20230503163654 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE avis CHANGE id_user id_user INT DEFAULT NULL, CHANGE id_bonplan id_bonplan INT DEFAULT NULL, CHANGE note_avis note_avis DOUBLE PRECISION NOT NULL');
        ...
        $this->addSql('ALTER TABLE commentaire CHANGE contenu contenu VARCHAR(50) NOT NULL');
        ...
        $this->addSql('ALTER TABLE evenement CHANGE date_debut_event date_debut_event VARCHAR(20) DEFAULT \'CURRENT_TIMESTAMP\' NOT NULL, CHANGE date_fin_event date_fin_event VARCHAR(20) DEFAULT \'CURRENT_TIMESTAMP\' NOT NULL');
        ...
        $this->addSql('ALTER TABLE quiz CHANGE score score INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE reservation CHANGE id_bonplan id_bonplan INT DEFAULT NULL, CHANGE id_user id_user INT DEFAULT NULL, CHANGE statut_reservation statut_reservation VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE utilisateur DROP nom, DROP prenom, DROP email, DROP dateDeNaissance, DROP numTel, DROP ville, DROP mdp, DROP role, DROP etat, DROP nombrejouer, DROP reset_token, DROP image');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE avis CHANGE id_user id_user INT NOT NULL, CHANGE id_bonplan id_bonplan INT NOT NULL, CHANGE note_avis note_avis DOUBLE PRECISION DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE commentaire CHANGE contenu contenu VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE evenement CHANGE date_debut_event date_debut_event DATE DEFAULT \'CURRENT_TIMESTAMP\' NOT NULL, CHANGE date_fin_event date_fin_event DATE DEFAULT \'CURRENT_TIMESTAMP\' NOT NULL');
        ...
        $this->addSql('ALTER TABLE quiz CHANGE score score INT DEFAULT 0');
        ...
        $this->addSql('ALTER TABLE reservation CHANGE id_bonplan id_bonplan INT NOT NULL, CHANGE id_user id_user INT NOT NULL, CHANGE statut_reservation statut_reservation VARCHAR(255) DEFAULT \'en attente\'');
        ...
        $this->addSql('ALTER TABLE utilisateur ADD nom VARCHAR(50) NOT NULL, ADD prenom VARCHAR(50) NOT NULL, ADD email VARCHAR(50) NOT NULL, ADD dateDeNaissance DATE DEFAULT NULL, ADD numTel INT NOT NULL, ADD ville VARCHAR(20) NOT NULL, ADD mdp VARCHAR(255) NOT NULL, ADD role LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', ADD etat LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', ADD nombrejouer INT DEFAULT NULL, ADD reset_token VARCHAR(10) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_general_ci`, ADD image VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_general_ci`');
    }
}
