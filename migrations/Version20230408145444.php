 ...
 */
final class Version20230408145444 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX fk_c6cfbfc4b1f8f49a ON command_produit');
        ...
        $this->addSql('CREATE INDEX IDX_D31F28A62FBB81F ON panier_produit (id_panier)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX FK_C6CFBFC4B1F8F49A ON command_produit (id_cmd)');
        $this->addSql('ALTER TABLE command_produit ADD CONSTRAINT FK_C6CFBFC4B1F8F49A FOREIGN KEY (id_cmd) REFERENCES commande (id_cmd)');
        ...
        $this->addSql('DROP INDEX IDX_D31F28A62FBB81F ON panier_produit');
        $this->addSql('ALTER TABLE panier_produit DROP FOREIGN KEY FK_D31F28A6EDB1BFF7');
